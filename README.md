...
- But the styles were not being applied.
  ...
  <img width="650" alt="image" src="screenshots/inspect-list-elements.png">
...
#### Update the SPFx version
https://learn.microsoft.com/en-us/sharepoint/dev/spfx/toolchain/update-latest-packages

https://pnp.github.io/cli-microsoft365/cmd/spfx/project/project-upgrade (I'm using this here)

- Install the Microsoft 365 CLI. https://pnp.github.io/cli-microsoft365/
```bash
...
- Install CodeTour plugin. https://plugins.jetbrains.com/plugin/19227-codetour
  ...
  <img width="350" alt="image" src="screenshots/install-code-tour.png">
- Create a new tour. This puts the `.tour` file in a folder in the root directory called `.tours`. Don't add it to Git.

  <img width="350" alt="image" src="screenshots/create-new-tour.png">
- Copy and paste the instructions from the `upgrade.tour` file generated by the CLI into the new tour. And you're ready to go!

  <img width="800" alt="image" src="screenshots/code-tour-steps.png">
